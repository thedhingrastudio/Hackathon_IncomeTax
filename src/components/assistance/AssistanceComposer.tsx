...
export default function AssistanceComposer() {
  return (
    <form className="assistance-composer" onSubmit={(event) => event.preventDefault()}>
      ...
      <div className="assistance-composer-row">
        <Input id="assistance-question" name="question" placeholder="Ask about your taxes…" type="text" />
      ...
      <p>Questions will shape this workspace in a later design increment.</p>
    </form>
  );
}
